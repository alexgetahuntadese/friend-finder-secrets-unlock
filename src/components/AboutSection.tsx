  ...
  return (
    <section id="about" ref={ref} className="relative py-24 px-4 overflow-hidden">
      ...
      >
        ...
        <div className="absolute bottom-10 right-10 w-96 h-96 rounded-full bg-gold/3 blur-3xl" />
      </motion.div>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-bold text-foreground mb-6">
            Your 4-Star Home in Bole Atlas
          </h2>
          <p className="text-muted-foreground font-body text-lg max-w-3xl mx-auto leading-relaxed">
            ...
            just 3.5 km from Bole International Airport. Experience genuine Ethiopian hospitality 
            paired with modern amenities and world-class service.
          </p>
        </motion.div>
        ...
        >
          {amenities.map((amenity, i) => (
            <motion.div
              ...
              className="flex flex-col items-center gap-3 p-5 rounded-xl bg-card shadow-card hover:shadow-warm transition-shadow"
            >
