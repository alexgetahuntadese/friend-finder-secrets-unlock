  ...
  return (
    <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden bg-primary grain">
      ...
      <div className="absolute inset-0 opacity-40">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-gold/10 blur-[120px] animate-pulse-glow" />
        <div className="absolute bottom-1/3 right-1/4 w-80 h-80 rounded-full bg-gold/5 blur-[100px] animate-pulse-glow" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <motion.div style={{ opacity }} className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="flex items-center justify-center gap-2 mb-8">
            {[...Array(4)].map((_, i) => (
              ...
              >
                <Star className="w-4 h-4 fill-gold text-gold drop-shadow-[0_0_6px_hsl(38_70%_50%/0.5)]" />
              </motion.div>
            ))}
          </div>
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-[5.5rem] font-bold text-cream mb-4 tracking-tight leading-[0.9]">
            Washington
            <span className="block text-gradient-gold mt-1">Hotel</span>
          </h1>
        ...
        >
          <a
            href="#rooms"
            className="group relative bg-gradient-gold px-10 py-4 rounded-full font-body font-semibold text-primary tracking-wide overflow-hidden transition-all duration-500 hover:shadow-[0_0_40px_hsl(38_70%_50%/0.35)] hover:scale-[1.02]"
          >
