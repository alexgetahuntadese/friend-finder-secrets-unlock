...
import { ArrowLeft, BookOpen, Clock, Target, Calculator, Atom, Zap, TreePine, Wheat } from 'lucide-react';

const NaturalSciencePage = () => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">
            Natural Sciences - Grade {grade}
          </h1>
          <p className="text-xl text-blue-200">
            Explore the natural world through mathematics, physics, chemistry, biology, and agriculture
          </p>
        </div>
